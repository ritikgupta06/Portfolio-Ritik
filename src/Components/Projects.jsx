...
const projects = [
  {
    ...
    description: "Developed the official website for Ignitia 2k24, our college’s cultural fest.",
    technologies: "Next.js, TypeScript, Django, RESTful API, AWS, MySQL",
    roles: "UI/UX Designer, Front-End Developer, Front-End Lead",
    impact: "Enhanced user engagement with event schedules, registration, and multimedia galleries.",
    imageUrl: "/ignita.png",
    link: "https://ignitia2k24-test.vercel.app/" // Replace with the actual project link
  },
  {
    title: "Engineering Grace",
    description: "Provides interactions with mentors to suggest the latest courses and career pathways.",
    technologies: "Next.js, Node.js, SQL, REST API",
    roles: "Full-Stack Developer, UI/UX Designer, Mentor Coordinator",
    impact: "Enabled students to make informed decisions on career pathways through tailored guidance.",
    imageUrl: "/eg.png",
  ...
  }, 
  {
    ...
    description: "Developed an innovative bus management system for college campuses.",
  ...
  },
  {
    ...
    description: "Provides access to past year question papers, toppers' notes, and mock tests.",
    ...
    impact: "Centralized study material repository with responsive UI and advanced search and filter functionalities.",
    imageUrl: "/ep.png",
        ...
        {projects.map((project, index) => (
          <div className="project-card" key={index}>
            <div className="project-text">
              ...
              <p className="project-roles"><strong>Roles:</strong> {project.roles}</p>
